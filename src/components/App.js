...
function App() {
  const [isUpdateAvatarPopupOpen, setIsUpdateAvatarPopupOpen] = React.useState(
    false,
  )
  const [
    isUpdateProfilePopupOpen,
    setIsUpdateProfilePopupOpen,
  ] = React.useState(false)
  const [isAddElementPopupOpen, setIsAddElementPopupOpen] = React.useState(
    false,
  )
  const [
    isConfirmDeletionPopupOpen,
    setIsConfirmDeletionPopupOpen,
  ] = React.useState(false)
  ...
  function handleCardLike(card) {
    ...
    api
      .toggleLikeApi(card._id, isLiked)
      .then((newCard) => {
        setCards((state) =>
      ...
      <div className="page">
        <div className="page__container">
          ...
          <ImagePopup
            ...
            onOverlay={closeViaOverlayClick}
          />

          {/*update avatar*/}
          <EditAvatarPopup
            isOpen={isUpdateAvatarPopupOpen}
            onCloseIcon={closeAllPopups}
            onOverlay={closeViaOverlayClick}
          ...
          <AddPlacePopup
            ...
            onCloseIcon={closeAllPopups}
            onOverlay={closeViaOverlayClick}
            onAddElement={handleAddPlaceSubmit}
          />
